...
function Furnicher({ addTo, deleteFrom, cart }) {
  ...
  React.useEffect(async () => {
    await firestore()
      ...
      .onSnapshot(snapshot => {
        ...
        setPost(newPost.filter(x => x.catagory === 'Furnicher'));
      });
  }, []);
...
export default connect(mapStatetoProps, mapDispatchtoProps)(Furnicher);
